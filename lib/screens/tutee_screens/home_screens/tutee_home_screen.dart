...
import 'package:tutor_search_system/screens/tutee_screens/tutee_map_screen/api_key.dart';
// import 'package:tutor_search_system/screens/tutee_screens/tutee_map_screen/demo_current.dart';
import 'package:tutor_search_system/screens/tutee_screens/tutee_map_screen/tutee_search_map.dart';
  ...
  return Container(
    child: GridView.builder(
      ...
      itemBuilder: (context, index) => CourseCard(
        ...
        tutorId: state.courses[index].createdBy,
      ),
    ),
  );
}
...
class CourseCard extends StatefulWidget {
  ...
  const CourseCard({Key key, this.course, this.tutorId}) : super(key: key);
      ...
      child: BlocProvider(
        ...
        child:
          ...
          if (state is TutorLoadingState) {
            ...
            _destinationAddress = state.tutor.address;
            // _destinationAddress = 'su van hanh ho chi minh';
            // _calculateDistance();
            return InkWell(
              onTap: () {
...
//       {Key key, @required this.course, @required this.tutorId})
//       : super(key: key);
//   @override
//   Widget build(BuildContext context) {
//     return InkWell(
